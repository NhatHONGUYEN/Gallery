...
export default function Home() {
  return (
    <div className="w-screen h-full">
      <div>
        <h1 className="text-[200px] mx-8  font-humane font-extrabold">
          RESEDA
        </h1>
          ...
          <div className="w-full lg:w-1/2 flex flex-col px-10 justify-between ">
            ...
            <div>
              <p className="font-mono pb-20">
                ...
                la photographie et directrice artistique. Son jeu avec la
                lumière et les ombres définit son style unique. Pour Sofia, les
                photos sont des métaphores. L’abstrait devient concret et
                l’ordinaire devient déroutant.
              </p>
